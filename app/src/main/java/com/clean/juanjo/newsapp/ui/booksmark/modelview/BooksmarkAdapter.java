...
import com.clean.juanjo.newsapp.ui.main.NewsClickListener;
...
public class BooksmarkAdapter extends RecyclerView.Adapter<BooksmarkAdapter.ViewHolder> {
    private List<ArticleModel> articles = new ArrayList<>();
    private NewsClickListener listener;
    private Context context;

    public BooksmarkAdapter() {
        context = NewsApp.getAppContext();
    }

    @Override
    public BooksmarkAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row,parent,false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(BooksmarkAdapter.ViewHolder holder, int position) {
